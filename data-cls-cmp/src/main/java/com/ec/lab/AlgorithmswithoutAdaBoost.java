 ...
 *
 */
public class AlgorithmswithoutAdaBoost {
    public void callAlgo(String inputFileSet) throws Exception {
        ...
        svm_Classifier.buildClassifier(data1);
        ...
        for (int i = 0; i < folds; i++) {
            ...
            eval_svm.evaluateModel(svm_Classifier, test2);
        }
        ...
        for (int i = 0; i < folds; i++) {
            Instances test2 = newData.testCV(folds, i);
            eval_nb.evaluateModel(nb_Classifier, test2);
        }
